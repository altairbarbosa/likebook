...
namespace __Interop
{
	...
	{
		// Signature, UrlMkSetSessionOption, [fwd] [return] [Mcg.CodeGen.BlittableValueMarshaller] int__int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, [fwd] [in] [Mcg.CodeGen.AnsiStringMarshaller] string__unsigned char *, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, 
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("Likebook, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Likebook.UserAgentHelper", "UrlMkSetSessionOption")]
		public static int UrlMkSetSessionOption(
					int dwOption, 
					string pBuffer, 
					int dwBufferLength, 
					int dwReserved)
		{
			// Setup
			byte* unsafe_pBuffer = default(byte*);
			int unsafe___value;
			try
			{
				// Marshalling
				unsafe_pBuffer = global::System.Runtime.InteropServices.McgMarshal.StringToAnsiString(pBuffer, true, false);
				// Call to native method
				unsafe___value = global::__Interop.urlmon_dll_PInvokes.UrlMkSetSessionOption(
									dwOption, 
									unsafe_pBuffer, 
									dwBufferLength, 
									dwReserved
			...
			{
				// Cleanup
				global::System.Runtime.InteropServices.ExternalInterop.SafeCoTaskMemFree(unsafe_pBuffer);
			}
		}
	}
	...
	public unsafe static partial class urlmon_dll_PInvokes
	{
		...
		[global::System.Runtime.InteropServices.DllImport("urlmon.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static int UrlMkSetSessionOption(
					int dwOption, 
					byte* pBuffer, 
					int dwBufferLength, 
					int dwReserved);
